...
img: assets/img/project_preview/ibctrans.svg
importance: 1
category: Academia
---
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/p_ibctrans.svg" title="iBCTrans Architecture" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
